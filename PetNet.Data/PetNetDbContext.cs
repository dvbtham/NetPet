...
namespace PetNet.Data
{
    public class PetNetDbContext : IdentityDbContext<ApplicationUser>
    {
        public PetNetDbContext()
            : base("PetNetConnection")
        {
        }
        ...
        public static PetNetDbContext Create()
        {
            return new PetNetDbContext();
        }
