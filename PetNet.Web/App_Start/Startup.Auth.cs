...
[assembly: OwinStartup(typeof(PetNet.Web.App_Start.Startup))]

namespace PetNet.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(PetNetDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<PetNetDbContext>());
