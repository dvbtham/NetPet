        ...
        public HttpResponseMessage Create(HttpRequestMessage request, ProductViewModel productVm)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    newProduct.StockStatus = productVm.Quantity.Value > 0 ? (int)ProductStatus.ConHang : (int)ProductStatus.HetHang;
        ...
        public HttpResponseMessage Update(HttpRequestMessage request, ProductViewModel productVm)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                else
                {
                    ...
                    dbProduct.StockStatus = productVm.Quantity.Value > 0 ? (int)ProductStatus.ConHang : (int)ProductStatus.HetHang;
