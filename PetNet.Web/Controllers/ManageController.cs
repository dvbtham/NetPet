...
namespace PetNet.Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> SetPassword(SetPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    MailHelper.SendMail(user.Email, "Kích hoạt tài khoản PetNet", "Chào bạn, bạn đang thiết lập lại mật khẩu, để kích hoạt tài khoản vui lòng <a href=\"" + callbackUrl + "\">click vào đây.</a>");
                    if (user != null)
                    {
                        await SignInManager.SignInAsync(user, isPersistent: false, rememberBrowser: false);
                    }
        ...
        public ActionResult GenerateQrCode()
        {
            ...
            {
                FileDownloadName = $"PetNet_qr_{userName}_{DateTime.Now:yyyyMMddhhmmsss}.png"
            };
