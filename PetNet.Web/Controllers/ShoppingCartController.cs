...
using PetNet.Web.App_Start;
using PetNet.Web.Infrastructure.Extensions;
using PetNet.Web.Infrastructure.NganLuongAPI;
using PetNet.Web.Models;
using static PetNet.Web.Infrastructure.Extensions.StockStatusHelper;
    ...
    public class ShoppingCartController : Controller
    {
        ...
        public ActionResult CreateOrder(string orderViewModel)
        {
            ...
            var info = new RequestInfo
            {
                ...
                fee_shipping = "0",
                Discount_amount = "0",
                order_description = "Thanh toán đơn hàng tại PetNet shop",
        ...
        private void ApplySendHtmlOrder()
        {
            ...
            MailHelper.SendMail(_userManager.GetUserById(User.Identity.GetUserId()).Email, "Đơn hàng từ PetNet.", htmlContent);
        }
