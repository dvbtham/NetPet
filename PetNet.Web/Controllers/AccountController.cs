    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel registerVm)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    MailHelper.SendMail(newUser.Email, "Kích hoạt tài khoản PetNet", content);
        ...
        public async Task<ActionResult> ForgotPassword(ExternalLoginConfirmationViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                MailHelper.SendMail(model.Email, "Đặt lại mật khẩu tài khoản PetNet", "Để đặt lại mật khẩu, vui lòng <a href=\"" + callbackUrl + "\"> click theo đường dẫn này</a>");
